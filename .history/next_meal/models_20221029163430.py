...
class run_log(models.Model):  # 运行日志
    eat_time = models.DateTimeField('上传时间', default=datetime.now())
    user_mark = models.CharField('地点', max_length=100, default='')
    is_login = models.CharField('上传人', max_length=100, default='')
    have_eat = models.CharField('名称', max_length=100)
