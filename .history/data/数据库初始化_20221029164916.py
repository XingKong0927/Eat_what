...
复制下方全部代码执行即可
'''
from eat.models import peikuang_jiaoding_meifen, rmam, ftable, prediction_data, linshi_canshu, yuanliao_choose, peikuang_lingsan, ftable_choose, sinter_xianding
