...
复制下方全部代码执行即可
'''
from eat_what.models import peikuang_jiaoding_meifen, run_log, ftable, prediction_data, linshi_canshu, yuanliao_choose, peikuang_lingsan, ftable_choose, sinter_xianding
